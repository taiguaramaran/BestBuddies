...
brad.photo.attach(io: file, filename: 'person.png', content_type: 'image/png')
brad.save!
...
celma.photo.attach(io: file, filename: 'person.png', content_type: 'image/png')
celma.save!

bill = User.new(name: 'Bill Moreno', address: '239, Kingsway', age: 39, role: 2, email: "bill.moreno@example.com", password: "123123")
bill.photo.attach(io: file, filename: 'person.png', content_type: 'image/png')
bill.save!
puts "Users Created !!!"
